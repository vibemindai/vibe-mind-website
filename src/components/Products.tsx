  ...
  const products = [
    {
      ...
      description:
        "Personalized spiritual guidance platform combining ancient wisdom with modern AI technology. Get insights, predictions, and personalized recommendations based on Vedic astrology and AI analysis.",
    ...
    },
    {
      ...
      description:
        "Next-generation community platform fostering digital collaboration with AI-driven engagement models. Smart content curation, intelligent matching, and automated community management.",
    ...
    <section id="products" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4 animate-fade-in">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">Innovation in Action</h2>
          <p className="text-lg text-muted-foreground">
            Flagship products showcasing the power of AI-first development and Vibe Coding
            philosophy
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          {products.map((product, index) => (
            ...
            >
              {/* Gradient Overlay */}
              <div
                className={`absolute top-0 left-0 right-0 h-2 bg-gradient-to-r ${product.gradient}`}
              />
              ...
              <CardHeader className="pt-8">
                ...
                <CardTitle className="text-2xl flex items-center gap-2">{product.name}</CardTitle>
